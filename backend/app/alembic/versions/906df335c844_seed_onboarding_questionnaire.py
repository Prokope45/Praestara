...
def upgrade():
    ...
    if superuser_row:
        ...
        # Define all questions for the onboarding questionnaire
        questions = [
            # Section A - Values and direction (text questions + likert)
            ...
            # Section B - Valued living across domains (10 domain ratings)
            ...
            # Section G - Current context and symptom burden (frequency scales)
        ...
        for question in questions:
            ...
            conn.execute(
                text("""
                    INSERT INTO question (id, questionnaire_id, question_text, "order", is_required, scale_type, custom_min_value, custom_max_value, custom_unit_label)
                    VALUES (:id, :questionnaire_id, :question_text, :order, :is_required, :scale_type, :custom_min_value, :custom_max_value, :custom_unit_label)
                """),
                {
                    "id": question_id,
